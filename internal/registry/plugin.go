...
// For shared package-level vars, call question.DeepCopy first.
func ApplyPlugin(flow *question.Question, plugin *Plugin) *question.Question {
...
func ApplyRegistry(flow *question.Question, registry *Registry) *question.Question {
